...
public struct UMLSAtom: UMLSUIType {
    ...
    public static var pattern: String = "^A\\d{7,8}$"
...
public struct UMLSDefinition: Decodable, Sendable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        public init(from decoder: any Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.sourceVocabulary = try container
...
public struct UMLSRelationship: Decodable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.additionalRelationLabel = try container
...
public protocol UMLSConceptController {
    ...
    /// - Throws: Raises ``UMLSError``.
    func definitions(using parameters: UMLSConceptDefinitionParameters) async throws -> UMLSPage<[UMLSDefinition]>
    ...
    /// - Throws: Raises ``UMLSError``.
    func relations(using parameters: UMLSConceptRelationParameters) async throws -> UMLSPage<[UMLSRelationship]>
