...
final class UMLSConceptInfoDecodableTests: XCTestCase {
    ...
    func conceptJSON(
        ui: String = "C\(Int.random(in: 1000000...9999999))",
...
""".data(using: .utf8)!
    ...
    func testValidDecoding() throws {
        ...
        XCTAssertEqual(object.dateAdded, DateComponents(calendar: .current, year: 1993, month: 04, day: 16).date!)
        XCTAssertEqual(object.majorRevisionDate, DateComponents(calendar: .current, year: 2022, month: 08, day: 10).date!)
